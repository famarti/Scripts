...
def experimento_timeit(listas, num):
    ...
    de selección, inserción, burbuja y merge para ordenamiento de listas
    ...
    return tiempos_seleccion, tiempos_insercion, tiempos_burbuja, tiempos_merge

tiempos_seleccion, tiempos_insercion, tiempos_burbuja, tiempos_merge = experimento_timeit(listas, 100)

plt.plot(tiempos_seleccion, c='r', label='Tiempo alg. seleccion')
plt.plot(tiempos_insercion, c='b', label='Tiempo alg. insercion')
plt.plot(tiempos_burbuja, c='g', label='Tiempo alg. burbuja')
plt.plot(tiempos_merge, c='k', label='Tiempo alg. merge sort')
plt.legend()
plt.show()