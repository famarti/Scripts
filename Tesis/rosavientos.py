...
# Filtrar valores negativos y valores de velocidad del viento muy bajos
...
# Crear el gráfico de la rosa de los vientos
...
plt.savefig(
    "windrose_enero.png", format="png", dpi=1000, bbox_inches="tight", pad_inches=0.5
)
